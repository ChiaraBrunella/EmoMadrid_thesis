...
scatter(logSF768_384, MeanArousal, 11, 'g')
hold on
scatter(logSF384_192, MeanArousal, 11, 'r')
hold on
scatter(logSF192_96, MeanArousal, 11, 'b')
hold on
scatter(logSF96_48,MeanArousal, 11, 'y')
hold on
scatter(logSF48_24, MeanArousal, 11, 'magenta')
hold on
scatter(logSF24_12, MeanArousal, 11, 'c')
hold on
scatter(logSF12_6, MeanArousal, 11,[0.8500 0.3250 0.0980] )
hold on
scatter(logSF6_3, MeanArousal, 11, [0.4940 0.1840 0.5560])
hold on
scatter(logSFresidual, MeanArousal, 11, [0.3010 0.7450 0.9330])
hold off
