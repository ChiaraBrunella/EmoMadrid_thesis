...
SizeInBytes = table2array(t(:,15));   
%Contrast = table2array(t(:,11));   
%Colorfulness = table2array(t(:,12));  
featureCongestion = table2array(t(:,18));  
SubbandEntropy = table2array(t(:,19));  
...
[r_EntrXAro, p_EntrXAro] = corrcoef(SubbandEntropy, MeanArousal)
[r_EntrXVal, p_EntrXVal] = corrcoef(SubbandEntropy, MeanValence)
[r_ConXEntr, p_ConXEntr] = corrcoef(featureCongestion, SubbandEntropy)
[r_ConXSize, p_ConXSize] = corrcoef(featureCongestion, SizeInBytes)
[r_SizeXEntr, p_SizeXEntr] = corrcoef(SizeInBytes, SubbandEntropy)
